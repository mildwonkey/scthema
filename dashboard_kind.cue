...
schemas: [
	{
		...
		schema:
		{
			...
			// [POC] a made up, optional field for test purposes
			colorpalette?: string| *"cool"
			// [POC] A made up required field - removing this is a backwards incompatible change
			absolutelyRequired: string
		...
		schema:
		{
			...
			// [POC] one of these changes is going to make this backward incompatible.
			header: string // nope, adding a field doesn't do it

			// Description of dashboard.
			description?: string

			// [POC] a made up, optional field for test purposes
			// removing this field is backward compatible
			colorpalette?: string| *"cool"

			// [POC] removing the previously-required field "absolutelyRequired" is backwards-incompatible.
